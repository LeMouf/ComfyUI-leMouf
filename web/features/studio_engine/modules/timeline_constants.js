...
export const SECTION_HEIGHT_STORAGE_KEY = "lemoufSong2DawSectionHeight";
...
export const SECTION_VIZ_STORAGE_KEY = "lemoufSong2DawSectionVizMode";
export const SKELETON_MODE_STORAGE_KEY = "lemoufStudioTimelineSkeletonMode";
export const TIMELINE_SNAP_STORAGE_KEY = "lemoufSong2DawTimelineSnapEnabled";
export const TRACK_ROW_SCALE_STORAGE_KEY = "lemoufSong2DawTrackRowScale";
