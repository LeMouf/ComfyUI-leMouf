export function createTimelineState(config = {}) {
  ...
  const state = {
    ...
    resizeObserver: null,
    autoFit: true,
    sectionHeight: normalizeSectionHeight(localStorage.getItem(CONSTANTS.SECTION_HEIGHT_STORAGE_KEY)),
    compactMode,
    ...
    sectionVizMode: normalizeSectionVizMode(localStorage.getItem(CONSTANTS.SECTION_VIZ_STORAGE_KEY)),
    skeletonMode: normalizeSkeletonMode(localStorage.getItem(CONSTANTS.SKELETON_MODE_STORAGE_KEY)),
    snapEnabled: normalizeSnapEnabled(localStorage.getItem(CONSTANTS.TIMELINE_SNAP_STORAGE_KEY)),
    trackRowScale: normalizeTrackRowScale(localStorage.getItem(CONSTANTS.TRACK_ROW_SCALE_STORAGE_KEY)),
    videoPreviewMode: normalizeVideoPreviewMode(localStorage.getItem(CONSTANTS.VIDEO_PREVIEW_MODE_STORAGE_KEY)),
